...
1. Prefer `src.core.skills.image_generation_skill.generate(...)` as the canonical runtime entry.
...
- The runtime implementation lives in `src/core/skills/builtin/image-generation/runtime.py`.
