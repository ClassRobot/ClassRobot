...
class OCRSkill(BaseProjectSkill):
    ...
    def __init__(self, manifest: SkillManifest) -> None:
        ...
        from src.shared.tools.ocr.crnn import CRNNHandle
        from src.shared.tools.ocr.dbnet.dbnet_infer import DBNET
    ...
    def read_lines(self, image: ImageInput, short_size: int = 1024) -> list[str]:
        ...
        import numpy as np
        from PIL import Image
        from src.shared.tools.ocr.utils import sorted_boxes, get_rotate_crop_image
