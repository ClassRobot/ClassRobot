...
_EXPORTS = {
    ...
    "AgentCatalog": ".delegation",
    "AgentDelegationDecision": ".delegation",
    "AgentHandoffRecord": ".delegation",
    "AgentHost": ".host",
    "AgentResultEnvelope": ".delegation",
    ...
    "SpecializedAgentDescriptor": ".delegation",
    "TaskWorkflow": ".schema",
