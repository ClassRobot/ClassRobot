...
from .observability import ProgressFeedbackHarness, ProgressReporter
...
class AutoGPTHarness:
    ...
    policy: AgentPolicyHarness
    context: AgentContextHarness
    ...
    def build(
        ...
        *,
        ...
        return cls(
            policy=AgentPolicyHarness(helpers=helpers),
            context=AgentContextHarness(
                messages=messages,
                runtime_context=runtime_context,
                local_knowledge_retriever=local_knowledge_retriever or AgentLocalKnowledgeRetriever(),
    ...
    @property
    def local_knowledge_retriever(self) -> AgentLocalKnowledgeRetriever:
