...
from utils.models import User, Classes, Student
from utils.models.depends import StudentDepends, UserOrCreatedDepends
...
from src.features.classes.services import can_manage_class
