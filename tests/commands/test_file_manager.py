...
async def test_private_file_commands_keep_user_space_isolated(
    ...
    from src.plugins.file_manager.commands import (
        cd_cmd,
        find_cmd,
        grep_cmd,
        ls_cmd,
...
async def test_file_manager_rejects_reserved_mount_directory_names(
    ...
    import src.plugins.file_manager.services as file_services
    from src.plugins.file_manager.commands import mkdir_cmd
    from utils.storage import StorageManager
...
async def test_student_file_scope_mounts_class_college_and_school_readonly(
    ...
    import src.plugins.file_manager.services as file_services
    from src.plugins.file_manager.commands import find_cmd, grep_cmd, ls_cmd, mkdir_cmd
    from utils.storage import StorageManager
