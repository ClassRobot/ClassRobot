...
1. Use `core.skills.markdown_to_image_skill.to_html(...)` when you need editable HTML output.
2. Use `core.skills.markdown_to_image_skill.to_image(...)` when Markdown can be rendered directly to an image.
3. Use `core.skills.markdown_to_image_skill.html_to_image(...)` when HTML has been post-processed before rendering.
